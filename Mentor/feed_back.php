...
if (isset($_GET["stuid"])) {
    ...
    $res = $conn->query("SELECT * FROM students WHERE stuid=$stuid");
    if ($res->num_rows == 1) {
    ...
    <div class="container">
        <div class="row">
            ...
            ?>
                ...
                <?php
                    header("Location: ./feed_back.php?stuid=$stuid");
                } else {
                ?>
                ...
                <form action="./feed_back.php" method="post" id="feedback_form">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <input type="hidden" class="form-control" name="sendby" id="sendby" value="mentor">

                            <div class="">
                                <label for="" class="form-label">Student Name</label>
                                <input type="text" name="stuname" id="stuname" class="form-control" placeholder="Student's Name" value="<?php echo $stuname ?>" disabled>
                            </div>
                            <div class="mt-3">
            ...
            <div class="col-md-6">
                ...
                ?>
                    <a href="./feed_back.php?stuid=<?php echo $stuid ?>&page=<?php echo $i ?>&count=<?php echo $count ?>" class="btn btn-primary btn-sm"><?php echo $i ?></a>
                <?php
                }
                ?>
            </div>
